        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === "success") {
              console.log(result);
              (0, _alerts.showAlert)("success", "Signed up an logged in successfully!");
...
var stripe = Stripe("pk_test_51KVUakFjeISbRNbnPk20LZMloz7WCqAlTNXR1TssZtvXHM7kOztxuQGk2Iytc7KxSUkshCl3xW2nl24nvK0yKG8b00n6ThkOF0");
